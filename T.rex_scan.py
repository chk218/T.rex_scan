...
init()
print(Fore.RED + "Description "+Fore.GREEN+"   : SCRIPT TO AUDIT PAGES WORDPRESS")
init()
...
while not salir:
    ...
    init()
    print(Fore.RED + "5. "+Fore.WHITE+" Details of T.rex_scan")
    init()
    ...
    if opcion == 1:
        ...
        print ("")
        init()  
        print(Fore.RED + "[*]"+Fore.WHITE+"    Hello and welcome to " +Fore.GREEN+ "T.rex_scan (**)\n")
        init()
